  ...
  if (!('style' in lesson)) {
    return (
      ...
      >
        ...
        <span className="order-3 col-span-2 grid min-w-0 content-center gap-1 px-4 pb-4 lg:order-none lg:col-span-1 lg:px-0 lg:pb-0 lg:ps-4">
        ...
        <span className="order-2 flex items-center justify-end border-s border-border/70 px-4 lg:order-none lg:border-s-0 lg:px-0 lg:ps-3">
